...
const ORIGEM = { lat: -23.962, lng: -47.505 };
...
function calcularFrete(lat2, lon2) {
    ...
    const centavosKm = distanciaKm - parteInteira;
    const kmFinal = centavosKm <= 0.30 ? parteInteira : parteInteira + 1;

    return kmFinal * PRECO_POR_KM;
}
